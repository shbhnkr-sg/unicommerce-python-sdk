...
_EXPORT_JOB_TYPES = {
    ...
    "Putaway": {"required_filters": ["Created in Date Range"], "status": "needs_ui_filter_ids", "description": "Putaway operations", "columns": ["updated", "skuCode", "category", "inventoryType", "batchCode", "putawayCode", "ean", "putawayCreated", "putawayQuantity", "statusCode", "type"]},
    "Shipping Package": {"required_filters": ["Added in Date Range"], "status": "needs_ui_filter_ids", "description": "Shipping package data", "columns": ["saleOrderCode", "channel", "created", "updated", "totalPrice", "shippingProvider", "shippingMethod", "invoiceCode", "shippingAddressName", "shippingAddressLine1", "shippingAddressLine2", "shippingAddressCity", "shippingAddressState", "shippingAddressPincode", "shippingAddressPhone", "trackingNumber", "length", "height", "cod", "shippingCharges", "statusCode", "width", "zone"]},
    "Picklist": {"required_filters": ["In Date Range"], "status": "needs_ui_filter_ids", "description": "Picklist data", "columns": ["saleOrderCode", "status", "created", "updated", "itemTypeName", "batchCode", "shippingPackageCode", "picklistCode", "picklistStatus", "ean", "saleOrderItemCode"]},
    ...
    "Gatepass": {"required_filters": ["Created Date Range"], "status": "needs_ui_filter_ids", "description": "Gatepass records", "columns": ["status", "created", "updated", "hsnCode", "inventoryType", "shelf", "quantity", "unitPrice", "gatepassStatus", "color", "size", "brand", "itemName", "updatedAt", "createdAt", "type", "reason", "lostQuantity"]},
    "Invoice": {"required_filters": ["Created in Date Range"], "status": "needs_ui_filter_ids", "description": "Invoice data", "columns": ["skuCode", "invoiceCode", "igst", "cgst", "sgst", "quantity", "shippingPackageCode", "invoiceDate", "taxPercentage", "cess", "customerName", "invoiceTotal", "invoiceTax"]},
    ...
    "Tally Return GST Report": {"required_filters": ["Returned in Date Range"], "status": "needs_ui_filter_ids", "description": "GST return report for Tally", "columns": ["saleOrderCode", "shippingProvider", "invoiceCode", "shippingAddressName", "shippingAddressLine1", "shippingAddressLine2", "shippingAddressCity", "shippingAddressState", "shippingAddressCountry", "shippingAddressPincode", "shippingAddressPhone", "igst", "cgst", "sgst", "productCode", "unitPrice", "trackingNumber", "invoiceDate", "cess", "customerName", "returnType", "discountAmount"]},
    "Tally Cancel GST Report": {"required_filters": ["Created in Date Range"], "status": "needs_ui_filter_ids", "description": "GST cancellation report for Tally", "columns": ["saleOrderCode", "hsnCode", "shippingProvider", "invoiceCode", "shippingAddressName", "shippingAddressLine1", "shippingAddressLine2", "shippingAddressCity", "shippingAddressState", "shippingAddressCountry", "shippingAddressPincode", "shippingAddressPhone", "igst", "cgst", "sgst", "productCode", "unitPrice", "trackingNumber", "invoiceDate", "cess", "customerName", "discountAmount"]},
    "Fastlane Courier Allocation Error Logs": {"required_filters": ["Time Stamp of Error"], "status": "needs_ui_filter_ids", "description": "Courier allocation error logs", "columns": ["saleOrderCode", "shippingPackageCode", "shippingPackageStatus", "reversePickupCode", "channelCode", "shippingProviderCode", "errorMessage", "reversePickupStatus"]},
    "Courier Return Itemwise": {"required_filters": ["Sale Order Created In Date Range"], "status": "needs_ui_filter_ids", "description": "Item-wise courier return data", "columns": ["created", "skuCode", "shippingProvider", "inventoryType", "returnReason", "returnStatus", "returnDate", "saleOrderItemCode"]},
    "Inventory Ledger": {"required_filters": ["Created Date Range"], "status": "needs_ui_filter_ids", "description": "Monthly stock ledger", "columns": ["skuCode", "brand", "openingBalance", "closingBalance"]},
    ...
    "GRN": {"required_filters": ["Date Range (tag:1)"], "status": "server_bug", "description": "Goods received note data", "columns": ["updated", "facility", "itemTypeName", "category", "batchCode", "expiry", "vendorCode", "grnCode", "grnCreated", "purchaseOrderCode", "vendorName", "purchaseOrderCreated", "vendorInvoiceNumber", "itemTypeColor", "itemTypeSize", "itemTypeBrand", "reason"]},
    "Purchase Orders": {"required_filters": ["Date Range (tag:1)"], "status": "server_bug", "description": "Purchase order data", "columns": ["created", "updated", "facility", "itemTypeName", "hsnCode", "category", "igst", "cgst", "sgst", "gstTaxTypeCode", "quantity", "unitPrice", "vendorCode", "deliveryDate", "purchaseOrderCode", "purchaseOrderStatus", "cess", "pendingQuantity", "type", "approvedDate"]},
    "Sequence Detail": {"required_filters": ["Party Type (tag:1)"], "status": "server_bug", "description": "Sequence/numbering details", "columns": ["partyType", "currentValue", "prefix", "sequenceName"]},
    "Shipping Package Timeline": {"required_filters": ["Date Range (tag:1)"], "status": "server_bug", "description": "Shipping package timeline events", "columns": ["created"]},
